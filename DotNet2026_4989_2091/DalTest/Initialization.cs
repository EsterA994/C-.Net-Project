...
public static class Initialization
{
    ...
    {
<<<<<<< HEAD
        s_dal.Product.Create(new Product(1, "שחמט אלקטרוני", ProdCategory.אלקטרוניקה, 60, 20));
        s_dal.Product.Create(new Product(2, "הלך לי קלף", ProdCategory.קופסא, 50, 10));
        s_dal.Product.Create(new Product(3, "אנדרלמוסיה", ProdCategory.קופסא, 80, 15));
        s_dal.Product.Create(new Product(4, "ביגדיל", ProdCategory.קלפים, 50, 10));
        s_dal.Product.Create(new Product(5, "נמל תעופה", ProdCategory.קופסא, 120, 8));
        s_dal.Product.Create(new Product(6, "חבל קפיצה ארוך", ProdCategory.חצר, 35, 20));
        s_dal.Product.Create(new Product(7, "בובת ניו יורק", ProdCategory.פעוטות, 139, 16));
        s_dal.Product.Create(new Product(8, "Taki", ProdCategory.קלפים, 40, 10));
        s_dal.Product.Create(new Product(9, "משחק מגנטים", ProdCategory.הרכבה, 230, 12));
        s_dal.Product.Create(new Product(10, "כדור", ProdCategory.חצר, 12, 14));
=======
...
>>>>>>> main
    ...
    {
<<<<<<< HEAD
        s_dal.Sale.Create(new Sale(1, 101, 2, 89, false, new DateTime(2024, 12, 20), new DateTime(2025, 1, 15)));
        s_dal.Sale.Create(new Sale(2, 102, 1, 149, true, new DateTime(2024, 12, 25), new DateTime(2025, 1, 10)));
        s_dal.Sale.Create(new Sale(3, 103, 3, 199, false, new DateTime(2025, 1, 1), new DateTime(2025, 1, 31)));
        s_dal.Sale.Create(new Sale(4, 104, 1, 69, false, new DateTime(2024, 12, 15), new DateTime(2025, 2, 1)));
        s_dal.Sale.Create(new Sale(5, 105, 2, 179, true, new DateTime(2025, 1, 5), new DateTime(2025, 1, 20)));
        s_dal.Sale.Create(new Sale(6, 106, 1, 299, false, new DateTime(2024, 12, 28), new DateTime(2025, 1, 25)));
        s_dal.Sale.Create(new Sale(7, 107, 4, 49, false, new DateTime(2025, 1, 10), new DateTime(2025, 2, 10)));
        s_dal.Sale.Create(new Sale(8, 108, 2, 119, true, new DateTime(2024, 12, 22), new DateTime(2025, 1, 12)));
        s_dal.Sale.Create(new Sale(9, 109, 1, 249, false, new DateTime(2025, 1, 3), new DateTime(2025, 1, 30)));
        s_dal.Sale.Create(new Sale(10, 110, 3, 139, true, new DateTime(2024, 12, 18), new DateTime(2025, 1, 18)));
=======
